...
from ml_hitwh.model.enums import PlayerAndWind
...
#         ).limit(1)
#         record = (await new_session.execute(stmt)).one_or_none()
#
#         if record is not None:
#             raise BadRequestError("你已经记录过这场对局了，可以对此消息回复“撤销结算”指令撤销你的分数后重新记录")
#
#         new_session.add(GameRecordOrm(game_id=game.id, user=user, score=score))
#
