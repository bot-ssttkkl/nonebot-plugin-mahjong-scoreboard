...
from nonebot_plugin_mahjong_scoreboard.controller.utils import split_message, parse_int_or_error, parse_float_or_error
...
async def parse_set_season_user_point_args(event: MessageEvent, matcher: Matcher):
